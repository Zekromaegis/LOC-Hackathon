...
class Get_suggestions(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        check_vals = [
            ['Microsoft',9.4,0.2,400,100,500,100,3,1,2,0.3,0.7,0.5, 0.1,0.1,0.7],
            ['Quantify',8,0.6,400,50,500,50,1,0.4,2,0.5,0.3,0.3, 0.7,0.2,0.05],
            ['TCS', 8,1,300,150,450,150,1,0.1,1,1,0.2,0.5, 0.4,0.2,0.19],
            ['Acollite', 9,0.2,370,89,370,100,2,0.8,2,0.2,0.4,0.3, 0.1,0.1,0.75],
            ['MorganStanley',9,0.1,450,50,550,50,4,1,3,0.5,0.4,0.4, 0.2,0.1,0.65],
            #['JP Morgan',9.3,.3,400,50,500,75,3.5,.75,3,2,0.4,0.4, 0.25,0.25,0.25],
            #['Adobe',8.4,1,400,40,500,60,2,2,2,2,0.7,0.35, 0.1,0.3,0.5],
            ['Valve',9,1,420,60,500,50,2,0.1,5,2,0.8,0.29, 0.05,0.15,0.6],
            #['Google',9.4,0.4,400,100,550,50,3,0.2,2,1,0.6,0.5, 0.2,0.1,0.4],
            ['Oracle',8.4,0.4,400,50,450,90,2,0.2,1,0.5,0.9,0.5, 0.05,0.05,0.85],
            ['Haptic',9,0.23,350,100,450,70,2,0.3,1,0.5,0.2,0.4, 0.25,0.25,0.25],
            #['Infosys',8.2,.9,380,80,470,70,1,0.6,1,1,0.5,0.55, 0.33,0.33,0.27],
            ['Grofers',8,0.7,420,80,500,50,2,0.4,2,1,0.5,0.55, 0.1,0.8,0.05],
            #['Flipkart',9.1,0.3,324,141,500,60,3,0.1,1,0.5,0.2,0.5, 0.4, 0.05, 0.4],
            ['Amazon',9.4,0.4,460,40,500,70,2,1,3,0.1,0.2,0.3, 0.2,0.1,0.5],
        ]
        ans_val = None
        for i in check_vals:
            if( i[0] == company ):
